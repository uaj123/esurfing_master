...
<title>角色信息</title>
<meta name="description" content="角色信息">
<meta name="keywords" content="角色信息">
									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/findRoleAndOtherPermissionsById.do?id=${role.id}" class="btn bg-olive btn-xs">添加角色权限</a>
