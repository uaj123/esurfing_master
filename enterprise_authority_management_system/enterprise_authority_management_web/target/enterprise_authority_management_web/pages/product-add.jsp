	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/product/findAllProduct.do">产品管理</a></li>
						...
						<div class="col-md-2 data">
							<label>
								<input type="text" class="form-control" name="productNum" id="productNum"
									placeholder="产品编号" value="${uuid}">
							</label>

						</div>
						<div class="col-md-2 data">
							<button onclick="location.href='${pageContext.request.contextPath}/uuid/getIdCard.do'" id="uuid" type="button" class="btn bg-maroon">生成编号</button>
						</div>
