...
<head>
    ...
    <title>产品信息</title>
    <meta name="description" content="产品信息">
...
<body class="hold-transition skin-purple sidebar-mini">
    ...
    <div class="wrapper">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sorting_desc sorting_desc_disabled">城市</th>
                                        <th class="sorting">出发时间</th>
                                        <th class="text-center sorting">价格</th>
                                        <th class="text-center sorting">产品简介</th>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 吴少杰<a href="#">自定义</a>.</strong> All rights reserved.
        </footer>
        <!-- 底部导航 /-->
