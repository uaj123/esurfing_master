		...
		<div class="content-wrapper">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							value="${orders.peopleGetCount}" readonly="readonly">
					</div>
			...
			<div class="panel panel-default">
				...
				<table id="dataList"
					...
					<thead >
						<tr>
							<th class="" style="text-align: center">旅客</th>
							<th class="" style="text-align: center">姓名</th>
							<th class="" style="text-align: center">性别</th>
							<th class="" style="text-align: center">手机号码</th>
							<th class="" style="text-align: center">证件类型</th>
							<th class="" style="text-align: center">证件号码</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								<td style="text-align: center"><input style="text-align: center" type="text" size="10" value="${traveller.travellerTypeStr}"
																	  readonly="readonly"></td>
								<td style="text-align: center"><input style="text-align: center" type="text" size="10" value="${traveller.name }"
									readonly="readonly"></td>
								<td style="text-align: center"><input style="text-align: center" type="text" size="10" value="${traveller.sex }"
									readonly="readonly"></td>
								<td style="text-align: center"><input style="text-align: center" type="text" size="20"
									value="${traveller.phoneNum }" readonly="readonly"></td>
								<td style="text-align: center"><input style="text-align: center" type="text" size="15"
									value="${traveller.credentialsTypeStr}" readonly="readonly"></td>
								<td style="text-align: center"><input style="text-align: center" type="text" size="28"
				...
				<!--联系人信息/-->
					...
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-2 data text">在线支付-${orders.payTypeStr}</div>

							<div class="col-md-1 title">金额</div>
							<div class="col-md-2 data text">￥${orders.product.productPrice}</div>
				...
				<c:if test="${orders.orderStatus== 0}">
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data text">${orders.orderStatusStr}</div>
